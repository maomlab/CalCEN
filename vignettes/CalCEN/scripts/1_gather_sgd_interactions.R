...
gdrive_path <- paste0(
    ...
    "Datasets/Sac Physical Interactions SGD 04-08-2019")
...
sac_sge_interactions <- dplyr::bind_rows(
    ...
    dplyr::left_join(
        ...
        by = "gene_symbol_2") |>
    dplyr::mutate(
        ca_feature_name_1 = ifelse(
            gene_symbol_1 == "HSP82", "C7_02030W_A", ca_feature_name_1),
        ca_feature_name_2 = ifelse(
            gene_symbol_2 == "HSP82", "C7_02030W_A", ca_feature_name_2))

save(
    sac_sge_interactions,
    file = "intermediate_data/sac_sge_interactions.Rdata")

...
system(
    paste0(
        "cd raw_data && ",
        "wget http://www.candidagenome.org/download/chromosomal_feature_files/",
...
chromosome_features <- readr::read_tsv(
    ...
    dplyr::mutate(
        feature_class = dplyr::case_when(
            ...
            feature_type |> stringr::str_detect("blocked_reading_frame") ~
                "gene_like",
            feature_type |> stringr::str_detect("centromere") ~ "centromere",
            TRUE ~ NA_character_),
        feature_status = dplyr::case_when(
            feature_type |> stringr::str_detect("Uncharacterized") ~
                "Uncharacterized",
...
system(
    paste0(
        "cd raw_data && ",
        "wget http://www.candidagenome.org/download/External_id_mappings/",
...
save(
    ...
    file = "intermediate_data/cgd_id_2_uniprot_accn.Rdata")
...
save(
    chromosome_feature_to_alias,
    file = "intermediate_data/chromosome_feature_to_alias.Rdata")
...
system(
    paste0(
        "cd raw_data && ",
        "wget http://www.candidagenome.org/download/homology/orthologs/",
        "C_albicans_SC5314_S_cerevisiae_by_CGOB/",
        "C_albicans_SC5314_S_cerevisiae_orthologs.txt"))
...
### Candida albicans SC5314 sequence assemblies in the
### Generic Feature Format (GFF)
system(
    paste0(
        "cd raw_data && ",
        "wget http://www.candidagenome.org/download/gff/",
        "C_albicans_SC5314/Assembly22/",
        "C_albicans_SC5314_version_A22-s07-m01-r123_features.gff"))
system(
    paste0(
        "cd raw_data ln -s ",
        "C_albicans_SC5314_version_A22-s07-m01-r123_features.gff ",
...
system(
    paste0(
        ...
        "wget http://www.candidagenome.org/download/gff/",
        "C_albicans_SC5314/Assembly22/",
        "C_albicans_SC5314_version_A22-s07-m01-r123_features.gtf"))
system(
    paste0(
        "cd raw_data ln -s ",
        "C_albicans_SC5314_version_A22-s07-m01-r123_features.gtf ",
...
system(
    paste0(
        ...
        "wget http://www.candidagenome.org/download/gff/",
        "C_albicans_SC5314/Assembly22/",
        "C_albicans_SC5314_version_A22-s07-m01-r123_intergenic.gff"))
system(
    paste0(
        "cd raw_data ln -s ",
        "C_albicans_SC5314_version_A22-s07-m01-r123_intergenic.gff ",
